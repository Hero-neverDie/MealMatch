  ...
  <div class="uk-container uk-container-small">
        <div class="uk-grid-large" data-uk-grid>
                            ...
                            <form>
                                <div class='uk-margin'>    
                                    <div class="uk-inline">
                                        ...
                                        <input class="uk-input uk-border-pill uk-form-width-large" type="text" v-model = "recipe.steps[index].step" >
                                    </div>
                                </div>
            ...
            <div class="uk-width-1-3@m">
                <div class="uk-flex">
                    <h3>4 - Ingredients </h3>
                    <a uk-icon="question" style="transform: translate(13%,15%);color:#EB4A36;" @click="suggest_ingredient"></a>
                </div>
                <form>
                    <div class='uk-margin'>    
                        <div class="uk-inline">
                ...
                <form>
                    <div class='uk-margin'>    
                        <div class="uk-inline">
                            ...
                            <input class="uk-input uk-border-pill uk-form-width-large" type="text"  v-model="input_tag" placeholder="Add Tags" >
                        </div>
                    </div>
                </form>
    ...
    <div class="uk-flex uk-flex-center">
        <a class="uk-button uk-button-primary uk-button-large uk-width-1-4" @click="submit_recipe">Create</a>
    </div>
...
export default {
    ...
    methods:{
        ...
        add_tag(tag){
            ...
            console.log(this.recipe.MealType)
        },
        remove_tag(tag){
        ...
        init(input_id){
            this.$http.get("get_user_name",{params:{id:input_id}}).then( res => {
                console.log(res.data)
                this.recipe.author =res.data
            })
        ...
        suggest_ingredient(){
            ...
            this.$http.get("ingredient/get_not_used_ingredients").then(res =>{
                const h = this.$createElement;
                var b = res.data
                this.$notify({
                title: 'Suggestion for Ingredients',
                message: h('i', { style: 'color: teal'}, `${b}`)
            });
            })
